...
export class Movies {
  ...
  setWatchlist(movieId: number): void { this.watchlistService.addToWatchlist(movieId); this.openMenuMovieId = null; }
  setWatched(movieId: number): void { this.watchlistService.markAsWatched(movieId); this.openMenuMovieId = null; }
  removeFromList(movieId: number): void { this.watchlistService.removeFromWatchlist(movieId); this.openMenuMovieId = null; }
